...
5. You can change the *property values of different shaders* in the corresponding **js files** to control the effect of how those shaders work so that the final look of the scene will be changed too.
