 ...
 * **Documentation** and **Examples** have all the definitions and code which are very fundamental for reference.
  * The **js source files** that shows in the "*view source*" of each example need to be copied to the *local js file* from the __three-3.js-master-r102__ file which on the *Desktop*.
  ![view source](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-1.png "view source")
    ![three-3.js-master-r102](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-2.png "three-3.js-master-r102")
2. **Mesh** is one significant element when creating an object. Each mesh includes two elemtents — **geometry** and **material**.
 ...
 ![Geometries Categories](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-3.png "Geometries Categories")
...
![Materials Categories](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-4.png "Materials Categories")
...
![rotating IcosahedronGeometry with pink background color](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-5-.png "rotating IcosahedronGeometry with pink background color")
### Knowledge Points
 ...
 * For example : The **constructor** of *BoxGeometry*
 ![The constructor of BoxGeometry](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-7.png "The constructor of BoxGeometry")
 compares to the **constructor** of *IcosahedronGeometry*
  ![The constructor of IcosahedronGeometry](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-8.png "The constructor of IcosahedronGeometry")
  The **properties** of *MeshBasicMaterial*
    ![The properties of MeshBasicMaterial](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-9.png "The properties of MeshBasicMaterial")
    compares to the **properties** of *MeshNormalMaterial*
        ![The properties of MeshNormalMaterial](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-10.png "The properties of MeshNormalMaterial")
...
********************
 ...
 ![Exercise Content](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-12.png "Exercise Content")
 ### The final look of my exercise:
 ![00-MyPractice](/Session1-Intro,%20Basic%20Scene,%20Geometry,%20Material,%20Mesh/(README/(README)pictures/pic-11.png "00-MyPractice")
 ### Analysis:
